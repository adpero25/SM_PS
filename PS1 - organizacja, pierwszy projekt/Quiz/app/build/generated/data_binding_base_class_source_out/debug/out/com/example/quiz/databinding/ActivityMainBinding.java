...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button falseButton,
      ...
      @NonNull TextView questionTextView, @NonNull TextView scoreTextView,
      @NonNull TableRow tableRow1, @NonNull Button trueButton) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, falseButton, nextButton, progressBar,
          questionTextView, scoreTextView, tableRow1, trueButton);
    }
